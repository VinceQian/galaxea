...
locations <- data.frame(name = c("Carpinito Bros Pumpkin Patch & Corn Maze 南瓜农场&玉米迷宫"),
                date = c("2021-10-31"),
                pic = c("https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/pumpkinfarm.JPG"),
...
newlocation <- data.frame("2","Pacific Place / Downtown 太古广场/市中心",
                       "2021-12-21","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/taigu.jpg",
...
newlocation <- data.frame("3","Chinatown / International District 中国城/国际街区",
                       "2021-12-31","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/chinatown.jpg",
...
newlocation <- data.frame("4","Henry Art Gallery 亨利美术展览馆",
                          "2022-1-8","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/henryart.jpg",
                          "安静空旷的展厅，风格各异的作品。",
                          "独自行走在艺术品之间。",
...
newlocation <- data.frame("5","Union Bay Natural Area 联合湾自然区",
                          "2022-1-13","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/unionbay.jpg",
                          "湖光，群鸟，滩涂，树林，和悠闲的人们。",
                          "行走在夕阳下金色的小路上。",
                          "记得穿雨靴。可自备鸟类图鉴。")
...
newlocation <- data.frame("6","Northwest African American Museum 西北非洲裔美国人博物馆",
                          "2022-1-17","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/naam.jpg",
...
newlocation <- data.frame("7","Volunteer Park 志愿者公园",
                          "2022-1-29","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/volunteer.jpg",
...
newlocation <- data.frame("8","Lakeview Cemetery 湖景墓园",
                          "2022-1-29","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/lakeview.jpg",
...
newlocation <- data.frame("9","Ballard Locks 水门",
                          "2022-2-5","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/locks.jpg",
...
newlocation <- data.frame("10","West Point Lighthouse / Discovery Park 西点灯塔/探索公园",
                          "2022-2-5","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/discovery.jpg",
...
newlocation <- data.frame("11","Space Needle / Seattle Center 太空针塔/西雅图中心",
                          "2022-2-23","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/center.jpg",
...
newlocation <- data.frame("12","Hing Hay Park 庆喜公园",
                          "2022-2-23","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/hinghay.jpg",
...
newlocation <- data.frame("13","Gas Works Park 煤气厂公园",
                          "2022-2-26","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/gasworks.jpg",
...
newlocation <- data.frame("14","Woodland Park Zoo 林地公园动物园",
                          "2022-3-5","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/zoo.jpg",
                          "世界各地动物大赏，也是人类幼崽行为大赏。",
                          "带崽一家的欢乐周末。",
                          "安排一整天游览体验最佳。")
...
newlocation <- data.frame("15","Golden Gardens Park 金色花园",
                          "2022-3-22","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/golden.jpg",
...
newlocation <- data.frame("16","Museum of Pop Culture 流行文化博物馆",
                          "2022-6-10","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/pop.jpg",
...
newlocation <- data.frame("17","Chihuly Garden and Glass 奇胡利玻璃艺术园 ",
                          "2022-6-11","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/chihuly.jpg",
                          "由吹制玻璃组成的幻想殿堂。",
                          "静坐光影之下仰望漫天琉璃。",
                          "土豪可以尝试买几个玻璃工艺品。")
...
newlocation <- data.frame("18","Seattle Aquarium 西雅图水族馆",
                          "2022-6-11","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/aquarium.jpg",
                          "世界各地水生生物大赏，又是人类幼崽大赏。",
                          "看着海豹晒太阳。",
                          "看热带鱼时多少有点头晕了。")
...
newlocation <- data.frame("19","Elliott Bay 埃利奥特湾",
                          "2022-6-11","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/elliott.jpg",
                          "西雅图最繁忙热闹的湾区。",
                          "在码头整点薯条。",
...
newlocation <- data.frame("20","Pike Place Market 派克市场",
                          "2022-6-11","https://raw.githubusercontent.com/VinceQian/galaxea/main/locationpic/pike.jpg",
                          "西雅图著名的小商品市场。",
                          "在旧物市场翻箱倒柜。",
